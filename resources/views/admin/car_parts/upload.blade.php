                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="upload-container">
                                        <h4 class="mb-4 text-center">Upload Car Parts via CSV</h4>
                                    ...
                                    <a href="{{ route('admin.car_parts.index') }}" class="btn btn-secondary mt-1 w-100">Back</a>

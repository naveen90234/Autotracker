                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="upload-container">
                                        <h4 class="mb-4 text-center">Upload Maintenance Task Type via CSV</h4>
                                    ...
                                    <a href="{{ route('admin.maintenance_task_types.index') }}" class="btn btn-secondary mt-1 w-100">Back</a>
    ...
    <script>
        $(document).ready(function() {
            $('#csvUploadForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('maintenance_task_types.uploadCSV') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,

    ...
    <div class="cover-wrap">
        ...
        <div class="container">
            ...
            <div class="main-container">
                <div class="box-one">
                    <form class="contact100-form" action="{{ route('submit-account-deletion-request') }}" method="POST">
                        @csrf
                        <span class="contact100-form-title">Request Account Deletion</span>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Please enter your reason">
                            <textarea class="input100" name="reason" placeholder="Your reason">{{ old('reason') }}</textarea>
                            <span class="focus-input100"></span>
                        </div>
                        <div style="margin-top:5px; margin-bottom:5px;" class="form-group">
                            <span id="title_error" class="text-danger alert-danger" role="alert">
                ...
                <div class="box-two">
                    <img class="supportImage" src="{{ asset('uploads/support_bg.png') }}" />
                </div>
            </div>
        </div>
